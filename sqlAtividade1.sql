...
CREATE TABLE SHIPPERS_TEMP(
	...
	ShipperTempID	SERIAL NOT NULL,
	CompanyName	VARCHAR(40) NOT NULL,
	Phone		VARCHAR(24) NOT NULL	

);

ALTER TABLE SHIPPERS_TEMP
	ADD CONSTRAINT pk_shipperstempID PRIMARY KEY (ShipperTempID);

ALTER TABLE SHIPPERS_TEMP
	ADD CONSTRAINT unq_shipperstempID UNIQUE (ShipperTempID);

CREATE TABLE USSTATES(

	UsstatesID	SERIAL NOT NULL,
...
ALTER TABLE USSTATES
	ADD CONSTRAINT pk_usstatesID PRIMARY KEY (UsstatesID);

ALTER TABLE USSTATES
	ADD CONSTRAINT unq_usstatesID UNIQUE (usstatesID);